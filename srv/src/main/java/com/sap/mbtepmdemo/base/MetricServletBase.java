...
public abstract class MetricServletBase extends com.sap.cloud.server.odata.metrics.MetricServlet {
    ...
    public void init(javax.servlet.ServletConfig config) throws javax.servlet.ServletException {
        ...
        provider.setCanModifySchema(getBooleanSetting(com.sap.mbtepmdemo.ProviderSettings.class, "CAN_MODIFY_SCHEMA", true));
        boolean trace = getBooleanSetting(com.sap.mbtepmdemo.MetricServlet.class, "TRACE_METRIC_SERVLET", false);
        boolean debug = trace || getBooleanSetting(com.sap.mbtepmdemo.MetricServlet.class, "DEBUG_METRIC_SERVLET", false);
        this.setTraceRequests(debug);
        this.setTraceWithData(trace);
        this.setPrettyTracing(trace);
        trace = getBooleanSetting(com.sap.mbtepmdemo.MetricServlet.class, "TRACE_METRIC_SERVICE", false);
        debug = trace || getBooleanSetting(com.sap.mbtepmdemo.MetricServlet.class, "DEBUG_METRIC_SERVICE", false);
